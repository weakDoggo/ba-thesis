...
\begin{figure}
    \centering
    \layerplot{data/num_layers_plot_molhiv_gcn.csv}{numLayers}{Number of Layers}{ROC-AUC}
...
\begin{figure}
    \centering
    \layerplot{data/num_layers_plot_molpcba_gcn.csv}{numLayers}{Number of Layers}{AP}
...
\begin{figure}
    \centering
    \layerplot{data/num_layers_plot_molesol_gcn.csv}{numLayers}{Number of Layers}{MSE}
...
\begin{figure}
    \centering
    \layerplot{data/num_layers_plot_mollipo_gcn.csv}{numLayers}{Number of Layers}{MSE}
...
\begin{figure}
    \centering
    \layerplot{data/probability_plot_molhiv_gcn.csv}{probability}{Number of Layers}{ROC-AUC}
    \caption{molhiv (GCN Model)}
    \label{fig:gcn-molfreesolv}
\end{figure}
...
\begin{figure}
    \centering
    \layerplot{data/probability_plot_molpcba_gcn.csv}{probability}{Probability}{AP}
    \caption{molpcba (GCN Model)}
    \label{fig:gcn-molfreesolv}
\end{figure}
...
\begin{figure}
    \centering
    \layerplot{data/probability_plot_molesol_gcn.csv}{probability}{Probability}{MSE}
    \caption{molesol (GCN Model)}
    \label{fig:gcn-molfreesolv}
\end{figure}
...
\begin{figure}
    \centering
    \layerplot{data/probability_plot_molfreesolv_gcn.csv}{probability}{Probability}{MSE}
    \caption{molfreesolv (GCN Model)}
    \label{fig:gcn-molfreesolv}
\end{figure}
...
\begin{figure}
    \centering
    \layerplot{data/probability_plot_mollipo_gcn.csv}{probability}{Probability}{MSE}
    \caption{mollipo (GCN Model)}
    \label{fig:gcn-molfreesolv}
\end{figure}
...
% Classification Datasets Insights 
\begin{figure}
    \centering
    \layerplot{data/num_layers_plot_molhiv_gin.csv}{numLayers}{Nuber of Layers}{ROC-AUC}
...
\begin{figure}
    \centering
    \layerplot{data/num_layers_plot_molpcba_gin.csv}{numLayers}{Nuber of Layers}{AP}
...
\begin{figure}
    \centering
    \layerplot{data/num_layers_plot_molesol_gin.csv}{numLayers}{Nuber of Layers}{MSE}
...
\begin{figure}
    \centering
    \layerplot{data/num_layers_plot_molfreesolv_gin.csv}{numLayers}{Nuber of Layers}{MSE}
...
\begin{figure}
    \centering
    \layerplot{data/num_layers_plot_mollipo_gin.csv}{numLayers}{Nuber of Layers}{MSE}
