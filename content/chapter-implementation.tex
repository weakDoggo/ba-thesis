...
% - [ ] 3.2.3 Finding the best Set of Hyperparameters: Move to 4.2 (Experimental Setup)
% - [ ] 4.2 Experimental Setup (first add 3.2.3, see previous task)
% 	- [ ] Add description of used hyperparams (used grid)
% 	- [ ] Add general training methodology:
% 		- [ ] Number of epochs
% 		- [ ] Number of repeats per param (3)
% 		- [ ] Mention early stopping (with which `patience` parameter)
% 		- [ ] Used criterion for selecting the best hp config (val_loss), used optimizer (Adam)
% 		- [ ] (maybe something else if you think of something we forgot)
In our experi