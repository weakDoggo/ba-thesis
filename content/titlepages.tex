...
%		\hspace*{1.3cm}33098 Paderborn
	...
	\includegraphics[height=1.8cm,width=4.7cm]{gfx/AIML_logo.jpg}\\
	\textsf{%Institute of Computer Science\\
	\hspace*{0.1cm}\small{Artificial Intelligence\\ \hspace*{0.1cm}and Machine Learning}
	}
	\end{minipage}
	\end{figure}
...
\AddToShipoutPictureBG*{\includegraphics[width=0.2\paperheight,height=0.2\paperheight]{gfx/siegel.pdf}}
